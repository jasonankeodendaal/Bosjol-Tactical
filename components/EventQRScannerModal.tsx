...
import { X, Camera, RefreshCw, CheckCircle2, AlertTriangle, ShieldCheck, MapPin, Calendar, Clock, Sparkles, Upload, ArrowRight, Check } from 'lucide-react';
...
export const EventQRScannerModal: React.FC<EventQRScannerModalProps> = ({
    ...
    const executeCheckIn = async (eventId: string) => {
