...
`;
    ...
    // FIX: Add backticks to create a valid template literal string.
                    ...
                    <div>
                        ...
                        <div className="flex justify-center gap-8 py-4">
                            ...
                            {companyDetails.phone && whatsappNumber && (
                                <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-red-400 transition-transform transform hover:scale-110" title="Message on WhatsApp">--- START OF FILE components/SettingsTab.tsx ---
