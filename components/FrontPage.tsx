    ...
    return (
        <Modal isOpen={true} onClose={onContinue} title="New Recruit Information">
            <div className="text-left space-y-4">
                <div className="flex items-center justify-center mb-2 text-center border-b border-zinc-700/50 pb-4">
                    <div className="w-12 h-12 rounded-xl bg-red-600/20 border border-red-500/40 flex items-center justify-center mr-4 flex-shrink-0 text-red-500">
                        <DocumentIcon className="w-7 h-7" />
                    </div>
                    <div className="text-left">
                        <h3 className="text-xl sm:text-2xl font-black text-white tracking-wider uppercase">MANDATORY BRIEFING</h3>
                        <p className="text-xs sm:text-sm text-zinc-400">Follow the enlistment protocol below to contact Command.</p>
                    </div>
                </div>

                <div className="max-h-[62vh] overflow-y-auto pr-1 sm:pr-2 space-y-5">
                    <div className="bg-zinc-900/60 p-4 rounded-xl border border-zinc-800">
                        <h4 className="font-bold text-sm uppercase tracking-wider text-red-400 mb-1.5 flex items-center gap-2">
                            <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
                            Welcome, Recruit
                        </h4>
                        <p className="text-zinc-300 text-xs sm:text-sm leading-relaxed">
                            To enlist with <strong className="text-white">Bosjol Tactical</strong>, you must initiate contact directly with Command. Click either the <strong className="text-emerald-400">WhatsApp</strong> or <strong className="text-red-400">Email</strong> channel below to launch your pre-formatted enlistment application.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                            ...
                            <a 
                                ...
                                className="group relative flex flex-col p-4 rounded-xl bg-gradient-to-br from-emerald-950/80 to-zinc-900 border border-emerald-500/40 hover:border-emerald-400 hover:shadow-lg hover:shadow-emerald-950/50 transition-all transform active:scale-[0.98]"
                            >
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="w-10 h-10 rounded-lg bg-emerald-500/20 border border-emerald-400/50 flex items-center justify-center text-emerald-400 group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-black transition-all">
                                    ...
                                    <div>
                                        <div className="font-bold text-white text-sm group-hover:text-emerald-300 transition-colors">WhatsApp Command</div>
                                        <div className="text-[11px] text-emerald-400/80 font-mono">{whatsappRawPhone}</div>
                                    </div>
                                </div>
                                <div className="mt-auto pt-2 flex items-center justify-between border-t border-emerald-900/40 text-xs font-semibold text-emerald-400">
                                    <span>Send Registration Msg</span>
                            ...
                            <a 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="group relative flex flex-col p-4 rounded-xl bg-gradient-to-br from-red-950/80 to-zinc-900 border border-red-500/40 hover:border-red-400 hover:shadow-lg hover:shadow-red-950/50 transition-all transform active:scale-[0.98]"
                            >
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="w-10 h-10 rounded-lg bg-red-500/20 border border-red-400/50 flex items-center justify-center text-red-400 group-hover:scale-110 group-hover:bg-red-500 group-hover:text-white transition-all">
                                    ...
                                    <div className="overflow-hidden">
                                        <div className="font-bold text-white text-sm group-hover:text-red-300 transition-colors">Official Email</div>
                                        <div className="text-[11px] text-red-400/80 truncate font-mono">{contactEmail}</div>
                                    </div>
                                </div>
                                <div className="mt-auto pt-2 flex items-center justify-between border-t border-red-900/40 text-xs font-semibold text-red-400">
                                    <span>Send Enlistment Email</span>
                                    <span className="text-sm">✉️ &rarr;</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="bg-zinc-950 p-3.5 rounded-xl border border-zinc-800">
                        <div className="flex justify-between items-center mb-2">
                            <span className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Enlistment Template Preview</span>
                            <button 
                                onClick={handleCopy}
                                className="px-2.5 py-1 text-xs font-semibold rounded bg-zinc-800 hover:bg-zinc-700 text-zinc-200 hover:text-white border border-zinc-700 flex items-center gap-1.5 transition-colors"
                            >
                                {copied ? (
                                    <>
                        ...
                        <pre className="text-zinc-400 text-[11px] whitespace-pre-wrap font-mono bg-zinc-900/90 p-2.5 rounded border border-zinc-800/80 max-h-28 overflow-y-auto">
                    ...
                    {companyDetails.fixedEventRules && (
                        <div>
                            <h4 className="font-bold text-xs uppercase tracking-widest text-red-400 mb-2">STANDARD OPERATING PROCEDURES</h4>
                            <pre className="text-zinc-300 text-[11px] whitespace-pre-wrap font-sans bg-zinc-900/50 p-3 rounded-lg border border-zinc-800">
                                {companyDetails.fixedEventRules}
                            </pre>
                        </div>
                    )}
                ...
                <div className="mt-4 pt-3 border-t border-zinc-700/50">
                    <Button onClick={onContinue} className="w-full font-bold">Understood, Continue to Tactical System</Button>
                </div>
            </div>
        </Modal>
    );
