  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-transparent p-4 overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-sm mx-auto text-center bg-zinc-950/60 backdrop-blur-sm border border-zinc-800/50 p-6 sm:p-8 rounded-lg shadow-2xl shadow-black/50"
      >
