    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="p-4 rounded-2xl bg-zinc-950/80 border border-cyan-500/30 space-y-2.5 shadow-lg">
                    <div className="flex items-center gap-2 text-cyan-400">
                        <Database className="w-5 h-5" />
                        <h4 className="text-sm font-black uppercase tracking-wider">Relational Schemas</h4>
                    </div>
                ...
                <div className="p-4 rounded-2xl bg-zinc-950/80 border border-emerald-500/30 space-y-2.5 shadow-lg">
                    <div className="flex items-center gap-2 text-emerald-400">
                        <Zap className="w-5 h-5" />
                        <h4 className="text-sm font-black uppercase tracking-wider">WebSocket Realtime CDC</h4>
                    </div>
                    <p className="text-xs text-zinc-300 leading-relaxed">
                ...
                <div className="p-4 rounded-2xl bg-zinc-950/80 border border-amber-500/30 space-y-2.5 shadow-lg">
                    <div className="flex items-center gap-2 text-amber-400">
                        <Server className="w-5 h-5" />
                        <h4 className="text-sm font-black uppercase tracking-wider">Automated Ledger Engine</h4>
                    </div>
                    <p className="text-xs text-zinc-300 leading-relaxed">
            ...
            <div className="p-4 sm:p-6 rounded-3xl bg-zinc-950/90 border border-zinc-800 shadow-2xl space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                    <div className="p-3.5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-1.5">
                        ...
                        <h5 className="text-xs font-bold text-white uppercase">Attendance Lock</h5>
                    ...
                    <div className="p-3.5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-1.5">
                        ...
                        <h5 className="text-xs font-bold text-white uppercase">RP &amp; XP Increment</h5>
                        <p className="text-[11px] text-zinc-400 leading-relaxed">
                    ...
                    <div className="p-3.5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-1.5">
                        ...
                        <h5 className="text-xs font-bold text-white uppercase">Milestone Badges</h5>
                        <p className="text-[11px] text-zinc-400 leading-relaxed">
                    ...
                    <div className="p-3.5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-1.5">
                        ...
                        <h5 className="text-xs font-bold text-white uppercase">Ledger Journal Entry</h5>
                        <p className="text-[11px] text-zinc-400 leading-relaxed">
            ...
            <div className="p-4 sm:p-6 rounded-3xl bg-zinc-950/90 border border-zinc-800 shadow-2xl space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-zinc-800">
                    <div>
                        <h4 className="text-base font-black text-white uppercase tracking-wider flex items-center gap-2">
                            <Layers className="w-5 h-5 text-indigo-400" /> Database Collections &amp; Relational Schemas
                        </h4>
                        <p className="text-xs text-zinc-400 mt-0.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                    {schemas.map((s, idx) => (
                        <div key={idx} className="p-3 rounded-xl bg-zinc-900/50 border border-zinc-800/80 space-y-1">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-mono font-bold text-cyan-400">{s.name}</span>
                                <span className="text-[10px] font-mono text-zinc-500">public.{s.name}</span>
                            </div>
