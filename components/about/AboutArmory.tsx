    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-800">
                ...
                <span className="px-3 py-1 rounded-full text-xs font-mono font-bold bg-zinc-900 text-amber-400 border border-zinc-800 self-start sm:self-auto">
                    TECH MASTER SPECS
                </span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <div className={`p-1.5 rounded-lg ${selectedCategory === cat.id ? 'bg-black/30 text-white' : 'bg-zinc-950 text-red-400 border border-zinc-800'}`}>
                                {cat.icon}
                            </div>
                            <span className="text-xs font-black uppercase truncate">{cat.label}</span>
                        </div>
                        <div className={`text-[10px] truncate ${selectedCategory === cat.id ? 'text-red-100' : 'text-zinc-400'}`}>
                            {cat.desc}
                        </div>
                    </button>
                ))}
            ...
            {selectedCategory === 'batteries' && (
                <div className="p-4 sm:p-6 rounded-3xl bg-zinc-950/90 border border-zinc-800 shadow-2xl space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-800">
                        <div>
                            <h4 className="text-base font-black text-white uppercase flex items-center gap-2">
                                <BatteryCharging className="w-5 h-5 text-amber-400" /> LiPo, Li-Ion &amp; NiMH Battery Chemistry Standards
                            </h4>
                            <p className="text-xs text-zinc-400 mt-0.5">
                                Safe charging, storage voltages, discharge rates (C-Rating), and MOSFET compatibility.
                            </p>
                        </div>
                        <span className="text-xs font-mono font-bold text-amber-400 bg-amber-950/60 px-2.5 py-1 rounded-full border border-amber-800/50 self-start sm:self-auto">
                            SMART CHARGING ONLY
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-black text-amber-400 uppercase">11.1v 3S LiPo Battery</span>
                                <span className="text-[10px] font-mono text-zinc-400">11.1V (12.6V Max)</span>
                            </div>
                            ...
                            <div className="p-2 rounded-xl bg-zinc-950 border border-zinc-800 text-[11px] font-mono text-zinc-400 space-y-0.5">
                        ...
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-black text-emerald-400 uppercase">7.4v 2S LiPo Battery</span>
                                <span className="text-[10px] font-mono text-zinc-400">7.4V (8.4V Max)</span>
                            </div>
                            <p className="text-xs text-zinc-300 leading-relaxed">
                        ...
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-black text-cyan-400 uppercase">Li-Ion 18650 / 21700</span>
                                <span className="text-[10px] font-mono text-zinc-400">7.4V / 11.1V Titans</span>
                            </div>
                            <p className="text-xs text-zinc-300 leading-relaxed">
                    ...
                    <div className="p-3.5 rounded-2xl bg-amber-950/20 border border-amber-800/40 text-xs text-amber-200 flex items-start gap-2">
            ...
            {selectedCategory === 'gas' && (
                <div className="p-4 sm:p-6 rounded-3xl bg-zinc-950/90 border border-zinc-800 shadow-2xl space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-800">
                        <div>
                            <h4 className="text-base font-black text-white uppercase flex items-center gap-2">
                                <Flame className="w-5 h-5 text-red-500" /> Gas Blowback (GBB), CO2 &amp; High-Pressure Air (HPA)
                            </h4>
                            <p className="text-xs text-zinc-400 mt-0.5">
                                Propellant pressures, cooldown management, silicone lubrication, and tournament lock mandates.
                            </p>
                        </div>
                        <span className="text-xs font-mono font-bold text-red-400 bg-red-950/60 px-2.5 py-1 rounded-full border border-red-800/50 self-start sm:self-auto">
                            PRESSURE TESTED
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <h5 className="text-xs font-black text-emerald-400 uppercase">Green Gas &amp; Silicone Maintenance</h5>
                            <p className="text-xs text-zinc-300 leading-relaxed">
                            ...
                            <ul className="text-xs text-zinc-400 space-y-1 pt-1 border-t border-zinc-800">
                        ...
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <h5 className="text-xs font-black text-cyan-400 uppercase">HPA Tanks, Regulators &amp; Tournament Locks</h5>
                            <p className="text-xs text-zinc-300 leading-relaxed">
            ...
            {selectedCategory === 'hopup' && (
                <div className="p-4 sm:p-6 rounded-3xl bg-zinc-950/90 border border-zinc-800 shadow-2xl space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-800">
                        <div>
                            <h4 className="text-base font-black text-white uppercase flex items-center gap-2">
                                <Target className="w-5 h-5 text-indigo-400" /> Hop-Up Engineering &amp; Precision Barrel Tuning
                            </h4>
                            <p className="text-xs text-zinc-400 mt-0.5">
                                Magnus effect backspin physics, bucking degrees (50° to 70°), and inner barrel bore dynamics.
                            </p>
                        </div>
                        <span className="text-xs font-mono font-bold text-indigo-400 bg-indigo-950/60 px-2.5 py-1 rounded-full border border-indigo-800/50 self-start sm:self-auto">
                            MAGNUS EFFECT
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <h5 className="text-xs font-black text-white uppercase">Bucking Hardness (Shore Durometer)</h5>
                        ...
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <h5 className="text-xs font-black text-white uppercase">Flat-Hop &amp; R-Hop Contact Patches</h5>
                            <p className="text-xs text-zinc-300 leading-relaxed">
                        ...
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <h5 className="text-xs font-black text-white uppercase">Tightbore vs. Widebore Barrels</h5>
                            <p className="text-xs text-zinc-300 leading-relaxed">
            ...
            {selectedCategory === 'rentals' && (
                <div className="p-4 sm:p-6 rounded-3xl bg-zinc-950/90 border border-zinc-800 shadow-2xl space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-800">
                        <div>
                            <h4 className="text-base font-black text-white uppercase flex items-center gap-2">
                                <PackageCheck className="w-5 h-5 text-emerald-400" /> Bosjol Tactical Rental Packages &amp; Inventory Management
                            </h4>
                            <p className="text-xs text-zinc-400 mt-0.5">
                                Complete gear setups for recruits, sanitization SOPs, and automatic armory reservations.
                            </p>
                        </div>
                        <span className="text-xs font-mono font-bold text-emerald-400 bg-emerald-950/60 px-2.5 py-1 rounded-full border border-emerald-800/50 self-start sm:self-auto">
                            TURNKEY BUNDLES
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <h5 className="text-xs font-black text-emerald-400 uppercase">Standard Combat Rental Bundle Includes:</h5>
                            <ul className="text-xs text-zinc-300 space-y-1.5">
                                <li className="flex items-center gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                                    <span>G&amp;G Combat Machine / Specna Arms Core M4 Carbine (360 FPS)</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                                    <span>2x High-Capacity 300-Round Winding Magazines</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                                    <span>High-Output 11.1v LiPo / Li-Ion Battery with Free Swaps</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                                    <span>Full-Face Thermal Anti-Fog Protective Mask (ANSI Z87.1+)</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                                    <span>2,000 High-Grade 0.25g Bio-Degradable BBs + Speedloader</span>
                                </li>
                            </ul>
                        </div>

                        <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                            <h5 className="text-xs font-black text-cyan-400 uppercase">Armory Sanitization &amp; Tech Inspection</h5>
                            <p className="text-xs text-zinc-300 leading-relaxed">
                            ...
                            <div className="p-2 rounded-xl bg-zinc-950 border border-zinc-800 text-[11px] font-mono text-zinc-400">
