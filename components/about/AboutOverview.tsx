...
export const AboutOverview: React.FC = () => {
    return (
        <div className="space-y-4 sm:space-y-6">
            {/* Tactical Combat Arena Visual Hero Banner - Flex Container with Real Layout Flow */}
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/15 bg-black shadow-[0_20px_50px_rgba(0,0,0,0.85)] group">
                <div className="relative min-h-[310px] sm:min-h-[280px] md:min-h-[290px] w-full overflow-hidden p-3.5 sm:p-5 md:p-6 flex flex-col justify-between gap-3 sm:gap-4">
                    {/* Background Image with Deep Gradient Shading */}
                    <img 
                    ...
                    <div className="relative z-10 flex items-center justify-between gap-2">
                        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/75 border border-red-500/50 backdrop-blur-md shadow-md">
                            <span className="w-2 h-2 rounded-full bg-red-500 animate-ping"></span>
                            <span className="text-[9px] sm:text-[10.5px] font-mono font-bold text-white tracking-wider uppercase whitespace-nowrap">
                                LIVE ARENA SECTOR 7
                            </span>
                        </div>
                        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/75 border border-emerald-500/50 backdrop-blur-md shadow-md">
                            <ShieldCheck className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                            <span className="text-[9px] sm:text-[10.5px] font-mono font-bold text-emerald-400 tracking-wider whitespace-nowrap">
                                MARSHAL MESH ACTIVE
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row sm:items-end justify-between gap-3 sm:gap-4">
                        <div className="space-y-1.5 min-w-0">
                            <div className="flex items-center gap-2 flex-wrap">
                                <span className="px-2 py-0.5 rounded bg-red-600/90 text-white font-mono text-[8.5px] sm:text-[9.5px] font-bold uppercase tracking-wider shadow-sm">
                                    Official Combat Grounds
                                </span>
                                <span className="text-[9.5px] sm:text-[10.5px] font-mono text-zinc-300 flex items-center gap-1">
                                    <MapPin className="w-3 h-3 text-red-400 inline shrink-0" /> Gauteng, South Africa
                                </span>
                            </div>
                            <h2 className="text-base sm:text-2xl md:text-3xl font-black text-white uppercase tracking-wider leading-tight drop-shadow-md">
                        ...
                        <div className="grid grid-cols-3 gap-1.5 sm:gap-2 self-stretch sm:self-auto shrink-0">
                            <div className="px-2.5 py-1.5 rounded-xl bg-black/75 border border-white/15 backdrop-blur-md text-center shadow-md">
                                <div className="text-[8px] sm:text-[9px] font-mono text-zinc-400 uppercase">Acreage</div>
                                <div className="text-[11px] sm:text-sm font-black font-mono text-amber-400">12.5 Ha</div>
                            </div>
                            <div className="px-2.5 py-1.5 rounded-xl bg-black/75 border border-white/15 backdrop-blur-md text-center shadow-md">
                                <div className="text-[8px] sm:text-[9px] font-mono text-zinc-400 uppercase">Capacity</div>
                                <div className="text-[11px] sm:text-sm font-black font-mono text-cyan-400">120+ Ops</div>
                            </div>
                            <div className="px-2.5 py-1.5 rounded-xl bg-black/75 border border-white/15 backdrop-blur-md text-center shadow-md">
                                <div className="text-[8px] sm:text-[9px] font-mono text-zinc-400 uppercase">Chrono</div>
                                <div className="text-[11px] sm:text-sm font-black font-mono text-emerald-400">1.50J Cap</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* 4 Core Operational Pillars - Side-by-Side 3D Squares with Full Text Legibility */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3.5">
                {/* 1. Combat Progression */}
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-b from-zinc-900/95 via-zinc-950/90 to-black border border-amber-500/30 hover:border-amber-500/60 transition-all space-y-2 shadow-[0_10px_25px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_16px_35px_rgba(245,158,11,0.2)] hover:-translate-y-0.5 backdrop-blur-md group flex flex-col justify-between">
                    <div className="space-y-1.5">
                        <div className="flex items-start gap-2">
                            <div className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-amber-500/20 text-amber-400 border border-amber-500/40 shrink-0 group-hover:scale-105 transition-transform shadow-inner mt-0.5">
                                <Zap className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                            </div>
                            <div className="min-w-0 flex-1">
                                <h4 className="text-[11px] sm:text-xs md:text-sm font-black text-white uppercase tracking-tight leading-tight">
                                    Combat Progression
                                </h4>
                                <p className="text-[8.5px] sm:text-[9.5px] text-amber-400 font-mono leading-tight mt-0.5">
                                    Rank Points Engine
                                </p>
                            </div>
                        </div>
                        <ul className="text-[9px] sm:text-xs text-zinc-300 space-y-1 pt-1.5 border-t border-white/10 leading-snug">
                            ...
                            <li className="flex items-start gap-1 hidden sm:flex">
                                <span className="text-amber-400 font-bold">•</span>
                                <span>Automated tier discounts &amp; VIP perks.</span>
                            </li>
                        </ul>
                    </div>
                    <div className="pt-1 text-[8px] sm:text-[9px] font-mono text-amber-400/80 uppercase tracking-tight">
                        Tier System Auto-Sync
                    </div>
                </div>

                {/* 2. Ballistics & Chrono */}
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-b from-zinc-900/95 via-zinc-950/90 to-black border border-red-500/30 hover:border-red-500/60 transition-all space-y-2 shadow-[0_10px_25px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_16px_35px_rgba(239,68,68,0.2)] hover:-translate-y-0.5 backdrop-blur-md group flex flex-col justify-between">
                    <div className="space-y-1.5">
                        <div className="flex items-start gap-2">
                            <div className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-red-500/20 text-red-400 border border-red-500/40 shrink-0 group-hover:scale-105 transition-transform shadow-inner mt-0.5">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="text-[8.5px] sm:text-[9.5px] text-red-400 font-mono leading-tight mt-0.5">
                                    Joules &amp; MED Safety
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="pt-1 text-[8px] sm:text-[9px] font-mono text-red-400/80 uppercase tracking-tight">
                        Tamper-Proof Tagging
                    </div>
                </div>

                {/* 3. Field Command */}
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-b from-zinc-900/95 via-zinc-950/90 to-black border border-emerald-500/30 hover:border-emerald-500/60 transition-all space-y-2 shadow-[0_10px_25px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_16px_35px_rgba(16,185,129,0.2)] hover:-translate-y-0.5 backdrop-blur-md group flex flex-col justify-between">
                    <div className="space-y-1.5">
                        <div className="flex items-start gap-2">
                            <div className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/40 shrink-0 group-hover:scale-105 transition-transform shadow-inner mt-0.5">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="text-[8.5px] sm:text-[9.5px] text-emerald-400 font-mono leading-tight mt-0.5">
                                    QR Check-in &amp; Roster
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="pt-1 text-[8px] sm:text-[9px] font-mono text-emerald-400/80 uppercase tracking-tight">
                        Sub-Second QR Check-In
                    </div>
                </div>

                {/* 4. Cloud Synchrony */}
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-b from-zinc-900/95 via-zinc-950/90 to-black border border-cyan-500/30 hover:border-cyan-500/60 transition-all space-y-2 shadow-[0_10px_25px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_16px_35px_rgba(6,182,212,0.2)] hover:-translate-y-0.5 backdrop-blur-md group flex flex-col justify-between">
                    <div className="space-y-1.5">
                        <div className="flex items-start gap-2">
                            <div className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-cyan-500/20 text-cyan-400 border border-cyan-500/40 shrink-0 group-hover:scale-105 transition-transform shadow-inner mt-0.5">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="text-[8.5px] sm:text-[9.5px] text-cyan-400 font-mono leading-tight mt-0.5">
                    ...
                    <div className="pt-1 text-[8px] sm:text-[9px] font-mono text-cyan-400/80 uppercase tracking-tight">
